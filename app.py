...
import chatapp.api.import_utils  # pylint: disable=unused-import
...
def chat():
    ...
    # The front-end may gather things in runtime and since things happens,
    # we may not inclusively uses /chat/<room>
...
if __name__ == "__main__":
    socketio.run(
        ...
        use_reloader=True,
        log_output=True,
        reloader_options={"extra_files": "/templates"},
    )
